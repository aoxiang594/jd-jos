...
class UeOrderNewAppointSiteRequest
{
	...
	public function getEngineerPhoto(){
	  return $this->engineerPhoto;
                        	                   			...
                        	                   			private $siteAcceptDate;
    	                        
	public function setSiteAcceptDate($siteAcceptDate){
		$this->siteAcceptDate = $siteAcceptDate;
         $this->apiParas["siteAcceptDate"] = $siteAcceptDate;
	}

	public function getSiteAcceptDate(){
