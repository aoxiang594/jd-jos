...
class UeOrderNewAppointEngineerRequest
{
	...
	public function getEngineerPhoto(){
	  return $this->engineerPhoto;
                        	                   			...
                        	                   			private $engAcceptDate;
    	                        
	public function setEngAcceptDate($engAcceptDate){
		$this->engAcceptDate = $engAcceptDate;
         $this->apiParas["engAcceptDate"] = $engAcceptDate;
	}

	public function getEngAcceptDate(){
	  return $this->engAcceptDate;
	}

                        	                   			private $nucleicAcidResult;
    	                        
	public function setNucleicAcidResult($nucleicAcidResult){
		$this->nucleicAcidResult = $nucleicAcidResult;
         $this->apiParas["nucleicAcidResult"] = $nucleicAcidResult;
	}

	public function getNucleicAcidResult(){
	...
	public function getTemperature(){
	  return $this->temperature;
                        	                   			...
                        	                   			private $temperatureTime;
    	                        
	public function setTemperatureTime($temperatureTime){
		$this->temperatureTime = $temperatureTime;
         $this->apiParas["temperatureTime"] = $temperatureTime;
	}
	...
	public function getTemperatureTime(){
	  return $this->temperatureTime;
                        	                   			...
                        	                   			private $isvaccinationTime;
    	                        
	public function setIsvaccinationTime($isvaccinationTime){
		$this->isvaccinationTime = $isvaccinationTime;
         $this->apiParas["isvaccinationTime"] = $isvaccinationTime;
	}

	public function getIsvaccinationTime(){
