...
class NbhouseRentBrokerstaffAddRequest
{
	...
	public function getBusinessLicense(){
	  return $this->businessLicense;
                        	                   			...
                        	                   			private $brokerQualificationCertificate;
    	                        
	public function setBrokerQualificationCertificate($brokerQualificationCertificate){
		$this->brokerQualificationCertificate = $brokerQualificationCertificate;
         $this->apiParas["brokerQualificationCertificate"] = $brokerQualificationCertificate;
	}

	public function getBrokerQualificationCertificate(){
	  return $this->brokerQualificationCertificate;
	}

                        	                   			private $agencyRecordCertificate;
    	                        
	public function setAgencyRecordCertificate($agencyRecordCertificate){
		$this->agencyRecordCertificate = $agencyRecordCertificate;
         $this->apiParas["agencyRecordCertificate"] = $agencyRecordCertificate;
	}

	public function getAgencyRecordCertificate(){
