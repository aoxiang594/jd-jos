...
class NbhouseRentSpuPublishServiceRequest
{
	...
	public function getSkuName(){
	  return $this->skuName;
                        	                        	                   			...
                        	                        	                   			private $houseSourceCode;
    	                        
	public function setHouseSourceCode($houseSourceCode){
		$this->houseSourceCode = $houseSourceCode;
         $this->apiParas["houseSourceCode"] = $houseSourceCode;
	}

	public function getHouseSourceCode(){
